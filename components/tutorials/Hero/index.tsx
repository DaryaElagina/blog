...
export default function Hero({ content, category, title, url, videoSrc, left }: HeroProps) {
  return (
    <div className="grid grid-cols-12 items-stretch gap-8">
      <div className="col-span-12 lg:col-span-5 xl:col-span-7">
        <p className="mb-3 text-lg leading-snug font-semibold tracking-wide text-purple-600 uppercase">
          {category}
        </p>
        <h2 className="mb-8 text-4xl font-extrabold tracking-tight text-gray-900 xl:text-6xl dark:text-gray-100">
          {title}
        </h2>
        <p className="mb-6 text-xl leading-8 font-medium text-gray-500 xl:text-2xl xl:leading-10">
          {content}
        </p>
        <a
          href={url}
