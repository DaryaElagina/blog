...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html
      ...
      className={`${GeistSans.variable} ${GeistMono.variable} ${GeistPixelSquare.variable} ${GeistPixelGrid.variable} ${GeistPixelLine.variable} scroll-smooth`}
    ...
    >
      ...
      <meta name="msapplication-config" content={`${basePath}/static/favicons/browserconfig.xml`} />
