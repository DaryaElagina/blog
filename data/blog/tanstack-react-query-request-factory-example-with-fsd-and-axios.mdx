...
- [ReactQueryKit](https://github.com/HuolalaTech/react-query-kit).
- [Query factories in @tanstack/react-query](https://tkdodo.eu/blog/the-query-options-api#query-factories).
- The FSD guide includes an [example](https://feature-sliced.design/docs/guides/tech/with-react-query#query-factory) of a query factory implementation.
